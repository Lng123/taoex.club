...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <a class="navbar-brand" href="/site/home"><img src="https://taoex.org/wp-content/uploads/2017/12/taoex-logo-white.png" height="36" width="141"></a><!-- link to profile page -->
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
                        <a class="nav-link" href="/site/home/club">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                        ...
                        <ul class="sidenav-second-level collapse" id="collapseComponents">
                            <li>
                                <a href="/site/home/matchHistory">Match history</a>
                            </li>
                            <li>
                                <a href="/site/home/applyNewMatch">Apply for a new match</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    ...
                    <span class="text-muted"><small><a href="/site/policy">     Privacy Policy</a></small></span>

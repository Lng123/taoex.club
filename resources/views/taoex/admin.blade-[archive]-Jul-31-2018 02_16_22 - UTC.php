        ...
        <li class="list-group-item" style="overflow:auto">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <input type="text" class="form-control" id="matchName" name="matchName" value="{{$match->name}}" style="display:none; width:30px"></td>
                  <input type="text" class="form-control" id="resultName" name="resultName" value="{{$result->id}}" style="display:none; width:30px"></td>


                  <td>{{ $result->firstName }} {{ $result->lastName }} @if ($result->winBonus != 0) <span style="color: red; font-size:14px">(Victory)</span>@endif</td>
                  <td><input type="number" min="0" class="form-control" id="hook" name="hook" value="{{ $result->hook }}"></td>
                  <td><input type="number" min="0" class="form-control" id="capture" name="capture" value="{{ $result->capture }}"></td>
                  <td><input type="number" min="0" class="form-control" id="elimination" name="elimination" value="{{ $result->elimination }}"></td>
                  <td><input type="number" min="0" class="form-control" id="winBonus" name="winBonus" value="{{ $result->winBonus }}"></td>
                  <td>
                                       <button type="submit" class="btn btn-outline-info"><i class="fa fa-fw fa-pencil"></i></button></span></td>
                </tr>
                </form>
                @endif
                @endforeach

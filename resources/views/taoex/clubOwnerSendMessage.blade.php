...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{route('manageClub')}}">Manage Club</a> 
      </li>
      <li class="breadcrumb-item active">Send Message</li>
    </ol>
    <div class="h3">Message Club Member</div>
            ...
            <div id="collapse2" class="panel-collapse collapse show">
              <ul class="list-group">
                <li class="list-group-item" style="overflow:auto">
                  <form method="POST" action="{{action('MessageController@sendClubMemberMessage')}}">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="message">New message to club member: {{$fullname}}</label>

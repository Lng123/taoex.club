    ...
    <div class="row">
      ...
      <div class="col-md-12" style="max-height: 1000px; overflow:auto;">
        ...
        <div class="alert alert-success" role="alert" style="margin-top:20px">
          ...
          <a class="btn btn-success" href=/home/admin>Reload </a> </div> @endif @if(isset($editSuccess)) <div class="alert alert-success" role="alert" style="margin-top:20px">
            <strong>Selected result has been updated.</strong>
            <a class="btn btn-success" href=/home/admin>Reload </a> </div> @endif @if(isset($deleteSuccess)) <div class="alert alert-success" role="alert" style="margin-top:20px">
              <strong>Match successfully deleted.</strong>
              <a class="btn btn-success" href=/home/admin>Reload </a> </div> @endif <div class="panel-group">
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                    ...
                    <ul class="list-group">
                      <li class="list-group-item" style="overflow:auto">
                        ...
                        <span style="float:right">
                          ...
                          <a class="btn btn-outline-info" style="float:right" href=/home/allMatch>View more...</a> </span> </li> </ul> </div> </div> </div> </div> <!-- /.container-fluid--> </div> <!-- /.content-wrapper--> </div> @endsection
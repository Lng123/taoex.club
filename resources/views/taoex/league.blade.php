...
<div class="content-wrapper" style="background-color:#d7d9e9">
                ...
                <div class="card mb-3 text-center border-dark bg-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group" style="color:gray">
                            ...
                            <li class="list-group-item" style="font-weight: bold;">League Name: <span style="text-align: right;">{{ isset($club) ? $club->name : 'No-name' }}</span></li>
                            
                            <li class="list-group-item" style="font-weight: bold;">League Owner: <span style="text-align: right;">{{ $clubOwner->firstName }} {{ $clubOwner->lastName }}</span></li>
                            ...
                            href="/home/clubFilter">More Info</a>
                            </span></li>
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h4 class="panel-title">
        <button type="button" class="btn btn-secondary" data-toggle="collapse" href="#collapse1" style="width:100%">Recent League Matches</button>
      </h4>
    </div>
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h4 class="panel-title">
        <button type="button" class="btn btn-secondary" data-toggle="collapse" href="#collapse3" style="width:100%">Record A League Match</button>
      </h4>
    </div>
      <ul class="list-group">
        <li class="list-group-item" style="overflow:auto">
...
<div class="panel-group">
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h4 class="panel-title">
        <button type="button" class="btn btn-secondary" data-toggle="collapse" href="#collapse4" style="width:100%">League Management</button>
      </h4>
    </div>
    <div id="collapse4" class="panel-collapse collapse show">
      <ul class="list-group">
        <li class="list-group-item" style="overflow:auto">
          ...
          <b style="color:gray">&nbsp;&nbsp; &nbsp;&nbsp;League Owner Functions</b></i></button>
                                  </h5>
            </div>
           <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
                <div class="card-body">
                    <div class="card-body">
                        <h6>Send message to League members</h6>
                        <br/>
                        @if(Auth::user()->club_owner == 1)
                            <div class="col=md-8">
                                You are a club owner
                                <br/>
                                You can send messages to your League members!
                                <br/>
                                <br/>
                            </div>
                            <form method="POST" action="{{ action('ClubController@sendMessage') }}">
                                    {{ csrf_field() }}
                                <div class="form-group">
